      ...
      >
        ...
        <div className="navbar-collapse collapse" id="navbarSupportedContent">
          <ul id="nav" className="navbar-nav ms-auto fw-bolder">
            ...
            <li className="nav-item ms-4">
              <a className="nav-link page-scroll pb-2 text-light" href="#bienvenue">
                À propos
              </a>
            </li>
            <li className="nav-item ms-4">
              <a className="nav-link page-scroll pb-2 text-light" href="#temoignages">
                Témoignages
              </a>
            </li>

            <li className="nav-item ms-4 me-4">
              <a className="nav-link page-scroll pb-2 text-light" href="#footer">
                Contact
              </a>
            </li>
          </ul>
            ...
            <div className="carousel-inner">
              ...
              <div className="carousel-item">
                ...
                >
                  ...
                  >
                    <div className="flex-grow-half"></div>
                    <h1 className="font-mali text-light fw-bolder fs-1">
                      Au coeur de la vibration
                    </h1>
                    <div className="container row justify-content-center">
                      <div className="col-lg-8 col-md-10 text-center">
                        <p className="text-light font-playfair mt-4 ">
          ...
          <div className="container">
            <div className="d-flex flex-column text-start text-light font-dancing-script fs-3 py-4">
              ...
              <Description>
                ...
                9h à 19h. Ma pratique repose sur une approche holistique, prenant en compte tous les
                aspects de votre être. Que vous cherchiez à surmonter le stress, à gérer l'anxiété,
                à améliorer vos relations ou à vous reconnecter avec vous-même, je suis là pour vous
            ...
            <div className="card card-sm border border-light border-opacity-50 text-start text-light font-playfair m-2 bg-transparent">
              <div className="card-body d-flex flex-column align-items-start">
                ...
                <div className="pt-4 w-100" style={{ maxWidth: '360px' }}>
                  <Description>
                    Je tiens à remercier Véronica tant pour son écoute que pour son
                    professionnalisme. Je l'ai consultée pour une problématique récurrente qui
                    enfin, est en passe d'être réglée définitivement. Et j'ai pu également
                    expérimenter les massages qu'elle propose... que de la douceur.... du pur
